...
export default {
    ...
    fetchByUserId: async(userId, params) => Axios.post(`/admin/gate/GetCheckedByUserId/${userId}`, params),
    ...
    resetPassword: async model => Axios.post(`/admin/gate/resetPassword`, model),
