  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        name: 'createUser',
        path: 'create',
        component: () => import('../components/views/managements/user/Create')
      },
      {
        name: 'EditUser',
        path: 'edit/:userId',
        component: () => import('../components/views/managements/user/Edit'),
        props: true
      }
    ]
  },
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            path: 'edit/:gateId',
            props: true,
            component: () => import('../components/views/managements/gate/Edit')
          }
        ]
      }
    ]
