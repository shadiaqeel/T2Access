...
$.extend($.validator, {
	...
	methods: {
		...
		equalTo: function(value, element, param) {
			...
			// TO=DO find a way to bind the event just once, avoiding the unbind-rebind overhead
...
;(function($) {
	...
	// TO=DO verify if jQuery 1.4's implementation is compatible with older jQuery special-event APIs
